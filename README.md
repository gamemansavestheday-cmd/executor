...
(IMPORTANT) INDENT|N
    - sets indentation level to N spaces for the next CREATE_FILE block
    - use this right before code blocks because some AIs have dogshit formatting
    - example:
      INDENT|4
      CREATE_FILE|main.c
      #include <stdio.h>
      ...
      END_FILE
    - indent automatically resets to 0 after END_FILE
